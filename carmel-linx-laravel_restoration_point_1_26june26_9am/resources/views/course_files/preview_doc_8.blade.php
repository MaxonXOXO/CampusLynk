<div class="max-w-[210mm] mx-auto bg-white text-black p-10 min-h-[297mm] shadow-[0_0_15px_rgba(0,0,0,0.1)] font-serif relative">
    ...
    <div class="text-center mb-6">
        <h2 class="text-xl font-bold uppercase underline decoration-2 underline-offset-4">Course Plan</h2>
    </div>
    ...
    @if(count($lessonPlans) == 0)
        <div class="text-center p-10 bg-red-50 text-red-600 rounded-lg border border-red-200 mt-10">
            ...
            <h3 class="text-lg font-bold">No Lesson Plan Found</h3>
            <p class="text-sm">Please generate your Lesson Plan from the Virtual Classroom first.</p>
        </div>
    @else
        <!-- Table -->
        <table class="w-full border-collapse border border-black text-sm mb-10 text-center">
            <thead>
