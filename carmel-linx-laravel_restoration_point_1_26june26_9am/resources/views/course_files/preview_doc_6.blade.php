<div class="w-full flex flex-col gap-8">
    ...
    <div class="max-w-[100%] overflow-x-auto mx-auto bg-white text-black p-10 min-h-[297mm] shadow-[0_0_15px_rgba(0,0,0,0.1)] font-serif relative border border-slate-200">
        ...
        <div class="text-center mb-6">
            <h2 class="text-xl font-bold uppercase underline decoration-2 underline-offset-4">Course Outcomes & CO-PO Mapping</h2>
        </div>
        ...
        <p class="text-sm text-slate-500 italic mb-4">Instructions: Enter your Course Outcomes below, and map them to the Program Outcomes (PO1-PO11) and Program Specific Outcomes (PSO1-PSO3). Enter 1, 2, or 3 for the mapping strength. Leave blank if not mapped.</p>
