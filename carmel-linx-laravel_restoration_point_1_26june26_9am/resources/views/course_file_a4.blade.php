...
<body>
    ...
    <div class="text-center" style="margin-top: 100px;">
        <h1 class="text-xl uppercase font-bold mb-4">Carmel Polytechnic College</h1>
        <h2 class="text-lg uppercase font-bold mb-8">Department of {{ $courseFile->batchSubject->batch->branch ?? 'General' }}</h2>
        
        <div style="border: 2px solid #000; padding: 40px; margin: 40px;">
            <h1 class="text-xl font-bold uppercase mb-4">Course File</h1>
            <h2 class="text-lg mb-8">Academic Year: {{ $courseFile->academic_year }}</h2>
