  ...
  <div class="bg-slate-900 border border-slate-700 rounded-3xl w-full max-w-7xl h-[95vh] flex flex-col shadow-2xl relative">
    ...
    <div class="px-6 py-4 border-b border-slate-800 flex justify-between items-center bg-slate-950/80 rounded-t-3xl">
      <div class="flex items-center gap-4">
        ...
        <div>
          <h2 class="text-xl font-black text-white tracking-tight flex items-center gap-2">
            ...
            <span id="fmdStatusBadge" class="px-2 py-0.5 rounded text-[10px] font-bold bg-green-500/10 text-green-400 border border-green-500/20">Active</span>
          </h2>
      ...
      <div class="flex items-center gap-3">
        <button id="fmdVerifyBtn" onclick="verifyStudentData()" class="px-4 py-2 bg-green-600/20 text-green-400 hover:bg-green-600 hover:text-white border border-green-500/30 rounded-xl text-xs font-bold transition-premium flex items-center gap-2 cursor-pointer">
          <span class="material-symbols-rounded text-sm">verified</span> Verify Data
        </button>
        <button onclick="downloadMentorPdf()" class="px-4 py-2 bg-slate-800 hover:bg-slate-700 text-white rounded-xl text-xs font-bold transition-premium flex items-center gap-2 cursor-pointer border border-slate-700">
    ...
    <div class="flex flex-1 overflow-hidden">
      ...
      <div class="w-64 bg-slate-950/50 border-r border-slate-800 p-4 flex flex-col gap-2 overflow-y-auto scrollbar-hidden shrink-0">
        <button onclick="switchDiaryTab('tab-profile')" id="btn-tab-profile" class="diary-tab-btn w-full text-left px-4 py-3 rounded-xl font-bold text-xs flex items-center gap-3 transition-premium bg-indigo-600/20 text-indigo-400 border border-indigo-500/30">
          <span class="material-symbols-rounded text-lg">person</span> Personal & Family
        </button>
        <button onclick="switchDiaryTab('tab-education')" id="btn-tab-education" class="diary-tab-btn w-full text-left px-4 py-3 rounded-xl font-bold text-xs flex items-center gap-3 transition-premium text-slate-400 hover:bg-slate-800">
          <span class="material-symbols-rounded text-lg">history_edu</span> Prior Education
        </button>
        <button onclick="switchDiaryTab('tab-academic')" id="btn-tab-academic" class="diary-tab-btn w-full text-left px-4 py-3 rounded-xl font-bold text-xs flex items-center gap-3 transition-premium text-slate-400 hover:bg-slate-800">
          <span class="material-symbols-rounded text-lg">school</span> Academic Progress
        </button>
        <button onclick="switchDiaryTab('tab-board')" id="btn-tab-board" class="diary-tab-btn w-full text-left px-4 py-3 rounded-xl font-bold text-xs flex items-center gap-3 transition-premium text-slate-400 hover:bg-slate-800">
          <span class="material-symbols-rounded text-lg">workspace_premium</span> Board Exams
        </button>
        <button onclick="switchDiaryTab('tab-extracurricular')" id="btn-tab-extracurricular" class="diary-tab-btn w-full text-left px-4 py-3 rounded-xl font-bold text-xs flex items-center gap-3 transition-premium text-slate-400 hover:bg-slate-800">
          <span class="material-symbols-rounded text-lg">emoji_events</span> Extra-Curricular
        </button>
        <button onclick="switchDiaryTab('tab-meetings')" id="btn-tab-meetings" class="diary-tab-btn w-full text-left px-4 py-3 rounded-xl font-bold text-xs flex items-center gap-3 transition-premium text-slate-400 hover:bg-slate-800">
          <span class="material-symbols-rounded text-lg">forum</span> Mentor Meetings
        </button>
        <button onclick="switchDiaryTab('tab-leaves')" id="btn-tab-leaves" class="diary-tab-btn w-full text-left px-4 py-3 rounded-xl font-bold text-xs flex items-center gap-3 transition-premium text-slate-400 hover:bg-slate-800">
          <span class="material-symbols-rounded text-lg">event_busy</span> Leave Record
        </button>
        <button onclick="switchDiaryTab('tab-discipline')" id="btn-tab-discipline" class="diary-tab-btn w-full text-left px-4 py-3 rounded-xl font-bold text-xs flex items-center gap-3 transition-premium text-slate-400 hover:bg-slate-800">
      ...
      <div class="flex-1 overflow-y-auto p-6 bg-slate-900 scrollbar-hidden relative">
        ...
        <div id="tab-profile" class="diary-tab block space-y-6">
          <div class="flex justify-between items-end border-b border-slate-800 pb-3">
            <div>
              <h3 class="text-lg font-black text-slate-200">Personal & Family Details</h3>
              <p class="text-[10px] text-slate-500 uppercase tracking-widest mt-1">Page 2 of physical diary</p>
            </div>
          </div>
          
          <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
            <div class="bg-slate-950/50 border border-slate-800 rounded-2xl p-5 space-y-4">
              <h4 class="text-sm font-bold text-indigo-400 border-b border-slate-800 pb-2">Student Particulars</h4>
            ...
            <div class="bg-slate-950/50 border border-slate-800 rounded-2xl p-5 space-y-4">
              <h4 class="text-sm font-bold text-indigo-400 border-b border-slate-800 pb-2">Local Guardian (If Hosteller)</h4>
              <div class="space-y-3 text-xs">
          ...
          <div class="bg-slate-950/50 border border-slate-800 rounded-2xl overflow-hidden">
            <div class="p-4 border-b border-slate-800 bg-slate-900/50 flex justify-between items-center">
              <h4 class="text-sm font-bold text-slate-200">Family Members</h4>
            </div>
        ...
        <div id="tab-education" class="diary-tab hidden space-y-6">
          <div class="flex justify-between items-end border-b border-slate-800 pb-3">
            <div>
              <h3 class="text-lg font-black text-slate-200">Prior Education & Fees</h3>
              <p class="text-[10px] text-slate-500 uppercase tracking-widest mt-1">Page 3 of physical diary</p>
            </div>
          </div>

          <div class="bg-slate-950/50 border border-slate-800 rounded-2xl overflow-hidden">
            <div class="p-4 border-b border-slate-800 bg-slate-900/50">
              <h4 class="text-sm font-bold text-slate-200">Courses Studied (SSLC / +2 / ITI)</h4>
            </div>
            <div class="overflow-x-auto">
              <table class="w-full text-left text-xs">
                <thead class="bg-slate-900 border-b border-slate-800 text-slate-500 uppercase">
          ...
          <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
             <div class="bg-slate-950/50 border border-slate-800 rounded-2xl p-5 space-y-4">
              <h4 class="text-sm font-bold text-indigo-400 border-b border-slate-800 pb-2">Scholarships & Grants</h4>
              <p id="fmdScholarships" class="text-xs text-white p-3 bg-slate-900 rounded-xl border border-slate-800 min-h-[60px]">--</p>
              <div class="flex items-center gap-3 mt-4 pt-4 border-t border-slate-800">
                <span class="text-xs text-slate-400 font-bold uppercase tracking-wider">Tuition Fee Waiver Beneficiary:</span>
                <span id="fmdFeeWaiver" class="px-2 py-1 bg-slate-800 text-white rounded font-bold text-xs border border-slate-700">No</span>
              </div>
            </div>
            
            <div class="bg-slate-950/50 border border-slate-800 rounded-2xl overflow-hidden flex flex-col">
              <div class="p-4 border-b border-slate-800 bg-slate-900/50">
                <h4 class="text-sm font-bold text-slate-200">Fee Payment History</h4>
              </div>
        ...
        <div id="tab-academic" class="diary-tab hidden space-y-6">
           <div class="flex justify-between items-end border-b border-slate-800 pb-3">
            <div>
              <h3 class="text-lg font-black text-slate-200">Academic Performance</h3>
              <p class="text-[10px] text-slate-500 uppercase tracking-widest mt-1">Page 4 of physical diary</p>
            </div>
          </div>
        ...
        <div id="tab-board" class="diary-tab hidden space-y-6">
           <div class="flex justify-between items-end border-b border-slate-800 pb-3">
            <div>
              <h3 class="text-lg font-black text-slate-200">Board Exam Results</h3>
              <p class="text-[10px] text-slate-500 uppercase tracking-widest mt-1">Semester-wise university results</p>
            </div>
          </div>
          ...
          <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
            ...
            <div class="bg-slate-950/40 rounded-xl p-3 border border-slate-800/60 flex flex-col justify-between">
              <div class="text-right">
                ...
                <span class="text-2xl font-black text-amber-400" id="mentorTotalActivityPoints">0</span>
              </div>
        ...
        <div id="tab-extracurricular" class="diary-tab hidden space-y-6">
           <div class="flex justify-between items-end border-b border-slate-800 pb-3">
            <div>
              <h3 class="text-lg font-black text-slate-200">Extra-Curricular Activities</h3>
              <p class="text-[10px] text-slate-500 uppercase tracking-widest mt-1">Page 7 of physical diary</p>
            </div>
            <button onclick="openActivityModal()" class="px-3 py-1.5 bg-indigo-600 hover:bg-indigo-700 text-white rounded-lg text-xs font-bold transition-premium cursor-pointer flex items-center gap-1"><span class="material-symbols-rounded text-sm">add</span> Add Activity</button>
          </div>
        ...
        <div id="tab-meetings" class="diary-tab hidden space-y-6">
          <div class="flex justify-between items-end border-b border-slate-800 pb-3">
            <div>
              <h3 class="text-lg font-black text-slate-200">Mentor-Mentee Meeting Details</h3>
              <p class="text-[10px] text-slate-500 uppercase tracking-widest mt-1">Page 10 of physical diary</p>
            </div>
            <button onclick="toggleDiaryAddForm()" class="px-4 py-2 bg-indigo-600 hover:bg-indigo-700 text-white rounded-xl text-xs font-bold transition-premium cursor-pointer flex items-center gap-2 shadow-lg shadow-indigo-500/20">
          ...
          <div id="fmdAddMeetingForm" class="hidden bg-indigo-950/20 border border-indigo-500/30 p-5 rounded-2xl space-y-4 mb-6">
            <h4 class="text-sm font-bold text-indigo-300 mb-2">Record Meeting Log</h4>
            <div class="grid grid-cols-2 gap-4">
              <div>
                <label class="block text-[10px] text-indigo-300/70 font-bold uppercase tracking-wider mb-1.5">Date</label>
                <input type="date" id="fmdMeetingDate" class="w-full bg-slate-900 border border-slate-700 rounded-xl px-3 py-2 text-xs text-white outline-none focus:border-indigo-500">
              </div>
              <div>
                <label class="block text-[10px] text-indigo-300/70 font-bold uppercase tracking-wider mb-1.5">Topic / Category</label>
                <input type="text" id="fmdMeetingCategory" class="w-full bg-slate-900 border border-slate-700 rounded-xl px-3 py-2 text-xs text-white outline-none focus:border-indigo-500" placeholder="e.g., Evaluation of Series Test">
              </div>
            </div>
            <div>
              <label class="block text-[10px] text-indigo-300/70 font-bold uppercase tracking-wider mb-1.5">Description</label>
              <textarea id="fmdMeetingNotes" rows="2" class="w-full bg-slate-900 border border-slate-700 rounded-xl px-3 py-2 text-xs text-white outline-none focus:border-indigo-500" placeholder="Details of the discussion..."></textarea>
            </div>
            <div>
              <label class="block text-[10px] text-indigo-300/70 font-bold uppercase tracking-wider mb-1.5">Suggestions / Action Taken</label>
              <textarea id="fmdMeetingAction" rows="1" class="w-full bg-slate-900 border border-slate-700 rounded-xl px-3 py-2 text-xs text-white outline-none focus:border-indigo-500" placeholder="What actions were recommended..."></textarea>
            </div>
            <div class="flex justify-end gap-2 pt-2">
              <button onclick="toggleDiaryAddForm()" class="px-4 py-2 text-xs font-bold text-slate-400 hover:text-white transition-premium cursor-pointer">Cancel</button>
              <button onclick="submitNewMeeting()" class="px-4 py-2 bg-indigo-600 hover:bg-indigo-700 text-white rounded-xl text-xs font-bold transition-premium cursor-pointer">Save Entry</button>
            </div>
          </div>
        ...
        <div id="tab-leaves" class="diary-tab hidden space-y-6">
           <div class="flex justify-between items-end border-b border-slate-800 pb-3">
            <div>
              <h3 class="text-lg font-black text-slate-200">Leave Record</h3>
              <p class="text-[10px] text-slate-500 uppercase tracking-widest mt-1">Page 13 of physical diary</p>
            </div>
            <button onclick="openLeaveModal()" class="px-3 py-1.5 bg-indigo-600 hover:bg-indigo-700 text-white rounded-lg text-xs font-bold transition-premium cursor-pointer flex items-center gap-1">
        ...
        <div id="tab-discipline" class="diary-tab hidden space-y-6">
           <div class="flex justify-between items-end border-b border-slate-800 pb-3">
            <div>
              <h3 class="text-lg font-black text-red-400">Disciplinary Actions</h3>
              <p class="text-[10px] text-slate-500 uppercase tracking-widest mt-1">Page 16 of physical diary</p>
            </div>
            <button onclick="openDiscModal()" class="px-3 py-1.5 bg-red-600/20 text-red-400 hover:bg-red-600 hover:text-white border border-red-500/30 rounded-lg text-xs font-bold transition-premium cursor-pointer flex items-center gap-1">
...
<script>
            ...
            for (const [segment, pts] of Object.entries(data.split)) {
              splitHtml += `
                <div class="flex justify-between items-center py-1">
                  <span class="text-[9px] text-slate-400">${segment}</span>
      ...
      for (const [semester, subjects] of Object.entries(data.academics)) {
          ...
          return `
            <tr class="border-b border-slate-800/40 hover:bg-slate-800/20">
              <td class="p-3">
                ...
                <div class="text-[9px] text-slate-500 font-mono">${s.subject_code} • ${s.type}</div>
              </td>
              <td class="p-3 text-[10px] text-center border-l border-slate-800/40">
        ...
        mAcContainer.innerHTML += `
          <div class="bg-slate-950/50 border border-slate-800 rounded-2xl overflow-hidden mb-6">
            <div class="p-3 border-b border-slate-800 bg-slate-900/50 text-sm font-bold text-indigo-300">
              Semester ${semester}
            </div>
            <div class="overflow-x-auto">
              <table class="w-full text-left text-xs">
                <thead class="bg-slate-900 border-b border-slate-800 text-slate-400 text-[10px] uppercase tracking-wider">
                  <tr>
    ...
    if (data.meetings && data.meetings.length > 0) {
      mTbody.innerHTML = data.meetings.map(m => {
        let badge = m.approval_status === 'Approved' 
          ...
          : `<span class="px-1.5 py-0.5 rounded text-[9px] font-bold bg-amber-500/10 text-amber-400 border border-amber-500/20">${m.approval_status}</span>`;
        
        return `
        <tr class="border-b border-slate-800/40 text-xs">
          <td class="p-3 font-mono text-slate-400">${m.date}</td>
          <td class="p-3 font-bold text-slate-300">${m.category}<br><span class="text-[9px] font-mono text-slate-500">By: ${m.logged_by_name}</span></td>
  ...
  function downloadMentorPdf() {
    window.open('/api/mentoring/download-pdf/' + currentMentoringRegNo, '_blank');
  }
...
<!-- ACTIVITY MODAL -->
  <div id="addActivityModal" class="fixed inset-0 bg-slate-950/80 backdrop-blur-sm z-[70] hidden items-center justify-center p-4">
    <div class="bg-slate-900 border border-slate-800 rounded-2xl w-full max-w-md p-6 shadow-2xl">
      <div class="flex justify-between items-center mb-6">
        <h3 class="text-lg font-black text-white" id="activityModalTitle">Add Activity</h3>
      ...
      <form id="activityForm" onsubmit="saveActivity(event)">
        ...
        <div class="space-y-4">
          <div>
            ...
            <select id="activitySegment" required class="w-full bg-slate-950 border border-slate-800 rounded-lg px-3 py-2 text-sm text-white focus:border-indigo-500">
          ...
          <div>
            ...
            <input type="text" id="activityName" required class="w-full bg-slate-950 border border-slate-800 rounded-lg px-3 py-2 text-sm text-white focus:border-indigo-500">
          </div>
          <div>
            <label class="block text-xs font-bold text-slate-400 mb-1">Level (e.g. State, College)</label>
            <input type="text" id="activityLevel" required class="w-full bg-slate-950 border border-slate-800 rounded-lg px-3 py-2 text-sm text-white focus:border-indigo-500">
          </div>
          <div class="grid grid-cols-2 gap-4">
            <div>
              <label class="block text-xs font-bold text-slate-400 mb-1">Points Claimed</label>
              <input type="number" id="activityPtsClaimed" required class="w-full bg-slate-950 border border-slate-800 rounded-lg px-3 py-2 text-sm text-white focus:border-indigo-500">
            </div>
            <div>
              <label class="block text-xs font-bold text-slate-400 mb-1">Points Awarded</label>
              <input type="number" id="activityPtsAwarded" required class="w-full bg-slate-950 border border-slate-800 rounded-lg px-3 py-2 text-sm text-white focus:border-indigo-500">
            </div>
          </div>
          <div>
            <label class="block text-xs font-bold text-slate-400 mb-1">Status</label>
            <select id="activityStatus" required class="w-full bg-slate-950 border border-slate-800 rounded-lg px-3 py-2 text-sm text-white focus:border-indigo-500">
  ...
  <div id="addLeaveModal" class="fixed inset-0 bg-slate-950/80 backdrop-blur-sm z-[70] hidden items-center justify-center p-4">
    <div class="bg-slate-900 border border-slate-800 rounded-2xl w-full max-w-md p-6 shadow-2xl">
      <div class="flex justify-between items-center mb-6">
        <h3 class="text-lg font-black text-white" id="leaveModalTitle">Add Leave Record</h3>
        ...
        <div class="space-y-4">
          <div class="grid grid-cols-2 gap-4">
            <div>
              ...
              <input type="number" id="leaveSem" required class="w-full bg-slate-950 border border-slate-800 rounded-lg px-3 py-2 text-sm text-white focus:border-indigo-500">
            </div>
            <div>
              <label class="block text-xs font-bold text-slate-400 mb-1">Date</label>
              <input type="date" id="leaveDate" required class="w-full bg-slate-950 border border-slate-800 rounded-lg px-3 py-2 text-sm text-white focus:border-indigo-500">
            </div>
          </div>
          <div>
            <label class="block text-xs font-bold text-slate-400 mb-1">Reason</label>
            <input type="text" id="leaveReason" required class="w-full bg-slate-950 border border-slate-800 rounded-lg px-3 py-2 text-sm text-white focus:border-indigo-500">
          </div>
          <div>
            <label class="block text-xs font-bold text-slate-400 mb-1">Status</label>
            <select id="leaveStatus" required class="w-full bg-slate-950 border border-slate-800 rounded-lg px-3 py-2 text-sm text-white focus:border-indigo-500">
          ...
          <div class="flex items-center gap-2">
            ...
            <label class="text-xs text-slate-300">Parent Informed?</label>
          </div>
  ...
  <div id="addDisciplinaryModal" class="fixed inset-0 bg-slate-950/80 backdrop-blur-sm z-[70] hidden items-center justify-center p-4">
    <div class="bg-slate-900 border border-slate-800 rounded-2xl w-full max-w-md p-6 shadow-2xl">
      <div class="flex justify-between items-center mb-6">
        <h3 class="text-lg font-black text-white" id="discModalTitle">Add Disciplinary Action</h3>
      ...
      <form id="discForm" onsubmit="saveDisciplinary(event)">
        ...
        <div class="space-y-4">
          <div>
            <label class="block text-xs font-bold text-slate-400 mb-1">Date</label>
            <input type="date" id="discDate" required class="w-full bg-slate-950 border border-slate-800 rounded-lg px-3 py-2 text-sm text-white focus:border-indigo-500">
          </div>
          <div>
            <label class="block text-xs font-bold text-slate-400 mb-1">Description</label>
            <textarea id="discDesc" required class="w-full bg-slate-950 border border-slate-800 rounded-lg px-3 py-2 text-sm text-white focus:border-indigo-500 h-24"></textarea>
          </div>
          <div>
            <label class="block text-xs font-bold text-slate-400 mb-1">Action Taken (Optional)</label>
            <textarea id="discAction" class="w-full bg-slate-950 border border-slate-800 rounded-lg px-3 py-2 text-sm text-white focus:border-indigo-500 h-20"></textarea>
          </div>
