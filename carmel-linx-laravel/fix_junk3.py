...
content = re.sub(r'EL [^\s]+ Student', r'EL \x26bull; Student', content)
...
content = re.sub(r'id="overallCgpa">[^<]+</div>', r'id="overallCgpa">-</div>', content)
content = re.sub(r'id="overallActivityPoints">[^<]+</div>', r'id="overallActivityPoints">-</div>', content)
