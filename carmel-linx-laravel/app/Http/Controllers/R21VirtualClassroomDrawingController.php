...
class R21VirtualClassroomDrawingController extends Controller
{
     ...
     * CIA: 40% Formative + 40% Summative + 20% Attendance = 50 Marks
     */
    public function show($subjectId)
    {
        ...
        // Enrolled Students Query (SQLite & MySQL compatible sorting)
     ...
     */
    public function generateR21DrawingLessonPlan($batchSubject, $drawingCourseFile)
    {
    ...
    public function printConsolidatedCia($subjectId)
    {
        ...
        if (view()->exists('r21_drawing.cia_consolidated_print')) {
    ...
    /**
     * SBTE Kerala Grading Scale Utility (Clause 13.1)
     */
    public static function calculateSbteGrade(float $marks, float $maxMarks = 100.0): array
    {
        $percentage = $maxMarks > 0 ? ($marks / $maxMarks) * 100.0 : 0.0;
