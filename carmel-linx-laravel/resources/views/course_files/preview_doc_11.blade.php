<div class="max-w-[210mm] mx-auto bg-white text-black p-10 min-h-[297mm] shadow-[0_0_15px_rgba(0,0,0,0.1)] font-serif relative">
    ...
    <div class="text-center mb-6">
        <h2 class="text-sm font-bold uppercase underline decoration-2 underline-offset-4">Internal Examination Result Analysis</h2>
    </div>
    ...
    @if(count($students) == 0)
        <div class="text-center p-10 bg-red-50 text-red-600 rounded-lg border border-red-200 mt-10">
            ...
            <h3 class="text-xs font-bold">No Marks Found</h3>
            <p class="text-[10px]">There are no student semester marks recorded for this subject in the database.</p>
        </div>
    @else
        <!-- Table -->
