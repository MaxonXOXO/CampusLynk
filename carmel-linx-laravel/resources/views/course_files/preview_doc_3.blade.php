<div class="max-w-[210mm] mx-auto bg-white text-black p-10 min-h-[297mm] shadow-[0_0_15px_rgba(0,0,0,0.1)] font-serif relative">
    ...
    <div class="text-center mb-6">
        <h2 class="text-sm font-bold uppercase underline decoration-2 underline-offset-4">Student List</h2>
    </div>
    ...
    <!-- Table -->
    <table class="w-full border-collapse border border-black text-[10px] mb-10">
        <thead>
