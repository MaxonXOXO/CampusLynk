...
<body>
    ...
    <div class="print-controls">
        <button class="btn-print" onclick="window.print()">Print QP</button>
        ...
        <table class="questions-table">
            <thead>
                <tr>
                    ...
                    <th class="text-left">Question Description</th>
                    <th style="width: 15%;" class="text-center">Cognitive Level (BT)</th>
            ...
            <tbody>
                ...
                @empty
                    <tr>
                        <td colspan="4" class="text-center" style="padding: 20px; font-style: italic;">No questions defined for this assignment yet.</td>
                    </tr>
                @endforelse
            </tbody>
        </table>
