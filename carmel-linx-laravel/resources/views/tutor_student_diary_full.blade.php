...
@endphp
  ...
  <aside class="w-full md:w-64 bg-slate-950 flex-shrink-0 flex flex-col border-r border-slate-800/80 z-20 shadow-xl overflow-y-auto">
    ...
    <!-- Student Info Card -->
    <div class="p-4 bg-indigo-950/30 border-b border-indigo-900/40">
      <p class="text-[9px] font-black uppercase tracking-widest text-indigo-400 mb-1">Viewing Diary For</p>
      <p class="font-black text-white text-sm" id="sidebarStudentName">Loading...</p>
      <p class="text-xs font-bold text-indigo-300 font-mono">{{ $studentRegNo }}</p>
    </div>

    <!-- Nav back to lecturer dashboard -->
    <nav class="flex-grow p-4 space-y-1.5">
      <a href="{{ $dashboardUrl }}" class="w-full text-left px-4 py-2.5 rounded-xl font-bold flex items-center gap-3 transition-premium text-slate-400 hover:bg-slate-800 hover:text-white cursor-pointer text-sm">
