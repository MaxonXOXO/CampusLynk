...
<head>
    ...
    <title>Assignment Marks Report - {{ $subject->subject_code }}</title>
    <style>
        :root {
            --primary: #1e3a8a;
            --border: #cbd5e1;
...
<body>
    ...
    <div class="a4-container">
        <div class="header">
            ...
            <h3>Formative Assessment Marks Report (Assignments)</h3>
        </div>
        ...
        <div class="section-title">Assignment Marks Grid (Out of 10)</div>
        <table>
            <thead>
                <tr>
            ...
            <tbody>
                @forelse($students as $idx => $s)
                    <tr>
                        ...
                        <td style="text-align: center; font-weight: bold;">{{ $s->assignment_marks['CO1'] }}</td>
