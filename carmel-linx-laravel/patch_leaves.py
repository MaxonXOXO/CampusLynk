...
# 1. Update populateMentoringUI to actually populate the leaves table
leaves_population = """    // Populate Leaves
...
if "const lList = document.getElementById('smdLeavesTable');" not in content:
