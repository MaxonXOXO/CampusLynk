...
new_func = r"""  function renderDiaryAcademicProgress(academics) {
    ...
    container.innerHTML = html + '<p class="text-[10px] text-slate-600 mt-1 px-1">* Internal marks based on assignments, written tests and online tests. Board exam marks are under the Board Exams tab.</p>';
  }
...
if start_idx != -1 and end_idx != -1:
    ...
    with open(path, "w", encoding="utf-8") as f:
        f.write(content)
    print("Updated renderDiaryAcademicProgress!")
else:
    print("ERROR: start_idx={} end_idx={}".format(start_idx, end_idx))
