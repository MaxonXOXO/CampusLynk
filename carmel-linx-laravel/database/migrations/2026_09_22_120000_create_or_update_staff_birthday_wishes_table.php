    ...
    public function up(): void
    {
        if (!Schema::hasTable('staff_birthday_wishes')) {
            Schema::create('staff_birthday_wishes', function (Blueprint $table) {
                ...
                $table->unique(['wish_date', 'celebrant_mobile_no', 'sender_mobile_no'], 'staff_birthday_wishes_idempotent_unique');
            });
        } else {
            Schema::table('staff_birthday_wishes', function (Blueprint $table) {
                $table->unique(['wish_date', 'celebrant_mobile_no', 'sender_mobile_no'], 'staff_birthday_wishes_idempotent_unique');
            });
        }
    }
