...
$parentFile = $baseViews . 'parent_dashboard.blade.php';
$parentLines = file($parentFile);

writePartial($baseViews . 'parent/profile-card.blade.php', sliceLines($parentLines, 285, 315));
writePartial($baseViews . 'parent/tab-attendance.blade.php', sliceLines($parentLines, 317, 414));
writePartial($baseViews . 'parent/tab-academic.blade.php', sliceLines($parentLines, 415, 600));
writePartial($baseViews . 'parent/scripts.blade.php', sliceLines($parentLines, 601, count($parentLines)));
...
file_put_contents($parentFile, $parentRoot);
echo "  [MODERNIZED] parent_dashboard.blade.php (" . count(file($parentFile)) . " lines)\n";
